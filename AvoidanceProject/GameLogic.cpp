...
using namespace std;
	...
	void GameLogic::Play()
	{
		...
		cout << _objects[0]->GetName();
		Console::SetCursorPosition((Console::WindowWidth() / 2) - (ScoreLength() / 2), (Console::WindowHeight() / 2) + 1);
		cout << "Score: " << score;
